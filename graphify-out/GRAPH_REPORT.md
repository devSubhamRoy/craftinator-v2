...
## Corpus Check
- 60 files · ~66,658 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 235 nodes · 373 edges · 18 communities (12 shown, 3 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0c864a1b`
...
1. `useLanguage()` - 55 edges
2. `Safe Feature Implementation Workflow` - 16 edges
3. `Example 1: New Feature Request Workflow` - 8 edges
4. `scripts` - 7 edges
5. `Phase 2 — Create an Implementation Plan` - 7 edges
6. `products` - 6 edges
7. `3. Development Guidelines & Conventions` - 6 edges
8. `Design Tokens (`src/index.css`)` - 6 edges
9. `Error Investigation Mode` - 6 edges
10. `useBodyScrollLock()` - 5 edges
...
Cohesion: 0.13
Nodes (12): ArtisanCardSkeleton(), BrandValues(), CommunitySection(), Hero(), MeetMakers(), Newsletter(), StoryBanner(), Testimonials() (+4 more)

### Community 3 - "ShopPage.jsx"
Cohesion: 0.12
Nodes (13): ArtisanDiscoveryBanner(), PersonalizedDiscovery(), ProductCard(), ProductCardSkeleton(), SellerCTA(), ShopByCategory(), ShopByMaterial(), ShopHero() (+5 more)
