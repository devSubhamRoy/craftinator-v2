...
## Corpus Check
- 64 files · ~76,410 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 244 nodes · 406 edges · 18 communities (12 shown, 3 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9e222f10`
...
Cohesion: 0.14
Nodes (11): ArtisanCardSkeleton(), CommunitySection(), Hero(), MeetMakers(), PersonalizedDiscovery(), StoryBanner(), Testimonials(), artisans (+3 more)

### Community 3 - "ShopPage.jsx"
Cohesion: 0.15
Nodes (10): ArtisanDiscoveryBanner(), ProductCard(), ProductCardSkeleton(), SellerCTA(), ShopByCategory(), ShopByMaterial(), ShopHero(), TrendingProducts() (+2 more)
...
Cohesion: 0.27
Nodes (6): BrandValues(), Newsletter(), editorialHeroCards, getProductReviews(), productReviews, ProductDetailsPage()
...
- **Why does `useLanguage()` connect `useLanguage` to `ProductDetailsPage.jsx`, `HomePage.jsx`, `ShopPage.jsx`?**
